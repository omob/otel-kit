...
const OUR_NAMES = ["Telemetry", "withSpan", "getTracer", "currentTraceId", "observeConnectionPool", "observeCpuUsage", "ArchitectureComponentType", "DocTraceState", "ExporterType", "HostNameMode", "InstrumentationName", "OtlpProtocol", "PropagatorType"];
